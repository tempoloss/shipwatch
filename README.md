...
answered once in 1.7 s with 122 identifiers, then timed out on three consecutive
retries — and ISO publishes maintenance releases annually. Polling 6-hourly
would be ~1,460 requests to catch one event.
